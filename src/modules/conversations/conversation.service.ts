...
export class ConversationService {
    ...
    async updateConversation(conversationId: string, dto: UpdateConversationDto, userId: string) {
        await this.getConversationMemberContext(conversationId, userId, {
            notFoundMessage: 'Conversation not found or user is not a member of this conversation',
        });
    ...
    async archiveConversation(conversationId: string, userId: string) {
        await this.getConversationMemberContext(conversationId, userId, {
            ...
            notFoundMessage: 'Conversation not found, already archived, or user is not a member of this conversation',
        });
    ...
    async unarchiveConversation(conversationId: string, userId: string) {
        await this.getConversationMemberContext(conversationId, userId, {
            ...
            notFoundMessage: 'Conversation not found, not archived, or user is not a member of this conversation',
        });
    ...
    async leaveChannel(conversationId: string, userId: string) {
        ...
        return await this.conversationMembersService.removeConversationMember(conversationId, userId);
    }
