...
export class PasswordService {
  ...
  async changePassword(userId: string, changePasswordDto: ChangePasswordDto) {
    ...
    const isMatch = await this.userService.isValidPassword(
    ...
    const isSamePassword = await this.userService.isValidPassword(
    ...
    await this.userService.updateUserPasswordById(
      user.id,
      changePasswordDto.newPassword,
    );
